      ...
      <div class="mg-top-20">
        ...
        <div class="" style="background: white;">
          ...
          <!--根据属性动态创建form表单-->
                    ...
                    :placeholder="'属性值在'+item.attributeRangeBegin+'～'+item.attributeRangeEnd+'之间'"
                    v-model="item.val"
                  />
        ...
        <el-tab-pane label="外部词条模板" name="outer">
          ...
          <div class="template-right">
            <h4 class="category-title">{{selectedCategory}}
              <img v-show="showFormat" @click="setTemplate" class="formatting" src="/static/image/geshishua.png" alt="" />
            </h4>
    ...
    >
      ...
      <div id="classifyFormDialog" class="template-right">
        <h4 class="category-title">{{selectedClassify}}
          <img v-show="classifyTemplateData.length" @click="setClassifyTemplate" class="formatting" src="/static/image/geshishua.png" alt="" />
        </h4>
...
export default {
  components: {treemenu,treeTransfer},
  name: 'editor',
  data() {
    return {
      imageUrl: '',
