<template>
	<div>
		<el-card class="myForm" shadow="hover">
			...
			<el-form :disabled="type==='see'" :model="ruleForm" :rules="rules" ref="ruleForm" label-position="right" label-width="100px" class="demo-ruleForm">
			  ...
			  <el-form-item v-if="type!=='see'" style="text-align: center;margin-top: 20px;">
