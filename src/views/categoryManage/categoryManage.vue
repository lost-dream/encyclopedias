    ...
    <div class="right-form">
      ...
      >
        ...
        <el-form-item style="text-align: center;padding-bottom: 100px;">
          <el-button
            style="background: #cccccc !important;color: black;border: none;"
            @click="
              form = {}
              formDisabled = true
            "
  ...
  data() {
    return {
      ...
      rules: {
        ...
        parentId: [{ required: true, message: '请指定父级分类', trigger: 'blur' }],
        grade: [{ type: 'number', required: true, message: '排序值必须为数字', trigger: 'blur' }],
